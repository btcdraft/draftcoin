...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Mar 27 23:59:42 2018
# Project:  DraftCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile DraftCoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_IPV6 -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DSTATIC -DQT_STATIC_BUILD -DUSE_UPNP=1 -DSTATICLIB -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/src/leveldb/libleveldb.a /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/src/leveldb/libleveldb.a /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: DraftCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
/home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/src/leveldb/libleveldb.a: FORCE
	cd /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/build/build.h: FORCE
	cd /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5; /bin/sh share/genbuild.sh /home/jcoberly/Documents/Wallets/DraftCoin/draftcoin-1.0.0.5/build/build.h
