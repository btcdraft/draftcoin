...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About DraftCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>DraftCoin</b> version", 0));
...
"Copyright \302\251 2015-2018 The DraftCoin developers", 0));
