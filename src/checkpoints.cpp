...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,   uint256("0x00000626d583465e39cc5eec2020f639792843efcfb4182d508e6734d4cfdab6") )
        ( 5000,   uint256("0xfc9f7e89ace12aa1bcca6009f083493222095cbce0c7e8408c7b5baba5a88e90") )
        ( 10000,  uint256("0x8446dd46ec6c972aa78c6716bcdaddeb91f4b8c5de0085eb8075e5691371c6e5") )
        ( 15000,  uint256("0x9ec222a3e7844ea42aa167d4d0d9cc1be5269fc662f4bce5c76dde57f3877b0b") )
        ( 20000,  uint256("0x6fdbd76fe6e91ac9a0f91e90a338cbe7a2be2a01eb33cbadc8bb3d737f5767d3") )
        ( 25000,  uint256("0x7735a8201df24d173db41f2c74c922f9b58fff4e262cbf93e286de860e47da18") )
        ( 50000,  uint256("0x7c6151e44bde90f2d29f96aa3d4e5a4b6e0077b78dcb6d30a1f0bbc6e2d55516") )
        ( 100000,  uint256("0x848cec46f8dcc0a0d30771943fd79c32c8f1ce0ae12cdc5d67a3cdbeb0baf31e") )
        ( 125000,  uint256("0x8c8b1c0d3087526424eda7a34de49e63f5ef103e57e0530ddcdceaa372a2ba1f") )
        ( 150000,  uint256("0x8832da836eea003529f7366d3a496d348949c194c5ab562b49de4ed27d065d83") )
        ( 175000,  uint256("0xa385badecc86719dffe76617ddded8741ee3974437e4cf17f83b68899a2c9add") )
        ( 200000,  uint256("0xac2312c11de9a3c050daaa6d0c80b2d338ccd79b3e7f311ad1dfe59fdf021757") )
        ( 225000,  uint256("0x288703520cd0cd05f4da79e25bb51b2aa412b0e1dcfb247d38c6dc28e67a8f86") )
        ( 250000,  uint256("0x1e43187cbe03ea14388cddbaad1abd61eedb544351897efee3325bc1789b01d2") )
        ( 275000,  uint256("0x07663110d281def84905567aa93f7b6efc5b7bf08693c0eb7b51448b267d9c08") )
        ( 300000,  uint256("0xc4640812ea290de88e9df7c56c30653931923e501234aaca0d7428b57538cca0") )
        ( 325000,  uint256("0xd07e3156687c55d21e166baae0547f997325ee7e9d111afb2a01e9ba48b91bb3") )
        ( 350000,  uint256("0x66740e369eb8d2be8d3d6f79d6a5d429a1d37c73ac74cde97be609f88932d779") )
    ;
    ...
    // draftcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // draftcoin: get last synchronized checkpoint
    ...
    // draftcoin: only descendant of current sync-checkpoint is allowed
    ...
    // draftcoin: reset synchronized checkpoint to last hardened checkpoint
...
// draftcoin: sync-checkpoint master key
...
// draftcoin: verify signature of sync-checkpoint message
...
// draftcoin: process synchronized checkpoint
