...
{
    resize(850+95, 550);
    setWindowTitle(tr("DraftCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
	...
	centralStackedWidget->addWidget(multiSendDialog);	
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a DraftCoin address"));
    ...
    aboutAction = new QAction(tr("&About DraftCoin"), this);
    aboutAction->setToolTip(tr("Show information about DraftCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for DraftCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("DraftCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("DraftCoin client"));
...
void BitcoinGUI::multiSendClicked(QString addr)
 {
     ...
     centralStackedWidget->setCurrentWidget(multiSendDialog);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DraftCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DraftCoin address or malformed URI parameters."));
    }
