...
#if defined(NDEBUG)
# error "DraftCoin cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 60 * 60 * 20; // 20 hours
...
const string strMessageMagic = "DraftCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	else if(pindexBest->nHeight+1 > 100 && pindexBest->nHeight+1 <= 15000)
    {
		nSubsidy = 0 * COIN;
    }	
...
#ifdef ENABLE_WALLET
// DraftCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("DraftCoin-loadblk");
